...
/**
 * Set display environment via DMA instead of using GPIO.
 * @param dispenv Pointer to display environment structure
 */
...
/**
 * Uploads a CLUT given by GsImage. Contrarily to GsSpriteFromImage(),
 * this function does not need a pointer to a GsSprite as it only
 * uploads CLUT data into VRAM.
 */
...
/**
 * Experimental!
 * @param drawenv Pointer to drawing struct
 * 
 */
